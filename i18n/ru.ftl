...
settings-file-preamble =
    ...
    #
    # `language` — язык, на котором говорит Demysto: "en" или "ru". Не пишите его, и
    # Demysto пойдёт за операционной системой, откатываясь к английскому.
    # { $languageEnv } перекрывает и то и другое.
    #
